...
var StickyScrollBar = function StickyScrollBar(_ref, ref) {
  ...
  var _useFrameState = (0, _useFrame.useFrameState)({
    scrollLeft: 0,
  ...
  var onMouseMove = function onMouseMove(event) {
    ...
    event.preventDefault(); // https://developer.mozilla.org/en-US/docs/Web/API/MouseEvent/buttons
  ...
  React.useEffect(function () {
    var onScrollListener = (0, _addEventListener.default)(window, 'scroll', onContainerScroll, false);
...
var _default = React.forwardRef(StickyScrollBar);
